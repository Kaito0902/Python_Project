...
class QuanLyLopTabbedPane(ctk.CTkFrame):
    def __init__(self, parent, ma_lop):
    ...
    def create_widgets(self):
        ...
        self.bang_diem_tab = BangDiemLop(notebook, self.ma_lop)
        notebook.add(self.bang_diem_tab, text="Bảng Điểm Lớp")

        self.cau_hinh_tab = CauHinhDiemFrame(notebook, self.bang_diem_tab, self.ma_lop)
